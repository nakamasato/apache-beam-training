...
dependencies {
    ...
    implementation("org.apache.beam:beam-runners-google-cloud-dataflow-java:2.51.0")
    ...
    runtimeOnly("org.apache.beam:beam-runners-direct-java:2.51.0")
...
if (project.hasProperty("dataflow-runner")) {
    dependencies {
        runtimeOnly("org.apache.beam:beam-runners-google-cloud-dataflow-java:2.51.0")
    }
}
