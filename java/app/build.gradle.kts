...
dependencies {
    ...
    implementation("org.apache.beam:beam-runners-google-cloud-dataflow-java:2.71.0")
    ...
    runtimeOnly("org.apache.beam:beam-runners-direct-java:2.70.0")
...
if (project.hasProperty("dataflow-runner")) {
    dependencies {
        runtimeOnly("org.apache.beam:beam-runners-google-cloud-dataflow-java:2.71.0")
    }
}
