...
dependencies {
    ...
    implementation("org.apache.beam:beam-runners-google-cloud-dataflow-java:2.64.0")

    // https://mvnrepository.com/artifact/org.apache.beam/beam-examples-java
    implementation("org.apache.beam:beam-examples-java:2.64.0")
...
if (project.hasProperty("dataflow-runner")) {
    dependencies {
        runtimeOnly("org.apache.beam:beam-runners-google-cloud-dataflow-java:2.64.0")
    }
}
